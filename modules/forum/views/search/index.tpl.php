<p class="pull-right"><?php echo icon('fa-comments').' <a href="'.url('forum/'.$forum_id.'/'.url_title($title)).'">'.$title.'</a> '.icon('fa-user').' '.($user_id ? $this->user->link($user_id, $username) : '<i>'.$this->lang('guest').'</i>').' '.icon('fa-clock-o').' '.time_span($date); ?></p>
