<form class="form-inline" action="<?php echo url($this->url->request); ?>" method="post">
	<div class="form-group">
		<label for="form_<?php echo $form_id; ?>_user"><?php echo $this->lang('player_single'); ?></label>
		<select class="form-control" name="<?php echo $form_id; ?>[user_id]">
			<option></option>
	...
	<div class="form-group" style="margin: 0 20px;">
		<label for="form_<?php echo $form_id; ?>_user"><?php echo $this->lang('role'); ?></label>
		<select class="form-control" name="<?php echo $form_id; ?>[role_id]">
			<option></option>
