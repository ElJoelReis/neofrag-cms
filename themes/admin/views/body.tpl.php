						...
						<div class="col-md-9 col-xs-12">
							<div class="btn-group">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li><a href="<?php echo url('user/'.$this->user->id.'/'.url_title($this->user->username)); ?>"><?php echo icon('fa-eye').$this->lang('view_my_profile'); ?></a></li>
								</ul>
							</div>
							<!--<div class="btn-group">
								<button type="button" class="btn btn-user btn-xs dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="page-actions pull-right">
					...
					<?php NeoFrag()->js('help'); ?>
					<a class="btn btn-outline btn-info btn-sm" href="<?php echo url($this->url->request); ?>" data-help="<?php echo 'admin/help/'.NeoFrag()->module->name.'/'.$module_method; ?>"><?php echo icon('fa-life-bouy'); ?><span class="hidden-sm"> <?php echo $this->lang('help'); ?></span></a>
					<?php endif; ?>
				</div>
			</div>
		</div>
