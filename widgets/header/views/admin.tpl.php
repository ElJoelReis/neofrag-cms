		...
		<div id="navigation-options" class="tab-pane active" role="tabpanel">
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select class="form-control" name="settings[align]" id="settings-align">
							<option value="text-left"<?php if (isset($align) && $align == 'text-left') echo ' selected="selected"'; ?>><?php echo $this->lang('left'); ?></option>
							<option value="text-center"<?php if (!isset($align) || $align == 'text-center') echo ' selected="selected"'; ?>><?php echo $this->lang('center'); ?></option>
							<option value="text-right"<?php if (isset($align) && $align == 'text-right') echo ' selected="selected"'; ?>><?php echo $this->lang('right'); ?></option>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" name="settings[title]" value="<?php if (isset($title)) echo $title; ?>" id="settings-title" placeholder="<?php echo $this->lang('default_title'); ?>" />
					</div>
					<div class="col-sm-3">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" name="settings[description]" value="<?php if (isset($description)) echo $description; ?>" id="settings-description" placeholder="<?php echo $this->lang('default_description'); ?>" />
					</div>
					<div class="col-sm-3">
						<div class="input-group">
							<div class="input-group-addon"><?php echo icon('fa-paint-brush'); ?></div>
